...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <body style="text-align: center">
        ...
        <div class="tgl"><p style="text-align: center; margin: 0px"><?= date("d F Y", strtotime($tgl_tes))?></p></div>
        <div class="tgl_akhir"><p style="text-align: center; margin: 0px"><b><?= date("d F Y", strtotime('+2 years', strtotime($tgl_tes)))?></b></p></div>
